...
@click.option('--skip-index',type=str,help='Path to txt file with indeces which were removed from the processed star - to preserve index of original star')
def create_sub_starfiles_from_embedding(input_star,embedding_path,centers_path,output_dir,num_neighbors = 5000,skip_index=None):
